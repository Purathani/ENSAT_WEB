...
--
-- Host: localhost    Database: ensat_v3
-- ------------------------------------------------------
...
CREATE TABLE `ACC_Biomaterial` (
  ...
  `normal_tissue` varchar(40) DEFAULT NULL,
  `normal_tissue_paraffin` varchar(40) DEFAULT NULL,
  `normal_tissue_dna` varchar(40) DEFAULT NULL,
...
CREATE TABLE `ACC_Biomaterial_Normal_Tissue` (
  ...
  `acc_biomaterial_id` int(11) NOT NULL DEFAULT '0',
  `ensat_id` int(11) NOT NULL,
  `center_id` varchar(5) NOT NULL,
  `normal_tissue_type` varchar(30) DEFAULT NULL,
  `normal_tissue_specific` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`acc_biomaterial_normal_tissue_id`,`acc_biomaterial_id`,`ensat_id`,`center_id`),
  KEY `ensat_id` (`ensat_id`,`center_id`)
...
CREATE TABLE `ACC_Chemotherapy` (
  ...
  KEY `ensat_id` (`ensat_id`,`center_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1232 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ACC_FollowUp` (
  ...
  KEY `ensat_id` (`ensat_id`,`center_id`)
) ENGINE=MyISAM AUTO_INCREMENT=21823 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ACC_Mitotane` (
  ...
  `mitotane_max_dosage` varchar(30) DEFAULT NULL,
  `mitotane_max_level` varchar(30) DEFAULT NULL,
...
CREATE TABLE `ACC_TumorStaging` (
  ...
  `size_of_adrenal_tumor` varchar(30) DEFAULT NULL,
...
CREATE TABLE `APA_BiochemicalAssessment` (
  ...
  `bilateral_avs` varchar(10) DEFAULT NULL,
...
CREATE TABLE `APA_Biomaterial` (
  ...
  KEY `fk_apa_biomaterial` (`ensat_id`,`center_id`)
...
CREATE TABLE `APA_Biomaterial_Normal_Tissue` (
  ...
  `apa_biomaterial_id` int(11) NOT NULL DEFAULT '0',
  `ensat_id` int(11) NOT NULL,
  `center_id` varchar(5) NOT NULL,
  `normal_tissue_type` varchar(30) DEFAULT NULL,
  `normal_tissue_specific` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`apa_biomaterial_normal_tissue_id`,`apa_biomaterial_id`,`ensat_id`,`center_id`),
  KEY `ensat_id` (`ensat_id`,`center_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `APA_PatientHistory` (
  ...
  `first_degree_relatives_hypertension` varchar(30) DEFAULT NULL,
  `first_degree_relatives_pal` varchar(30) DEFAULT NULL,
  `doc_genetic_disease` varchar(4) DEFAULT NULL,
  `lowest_kalemia` varchar(30) DEFAULT NULL,
...
CREATE TABLE `NAPACA_Biomaterial_Normal_Tissue` (
  ...
  `napaca_biomaterial_id` int(11) NOT NULL DEFAULT '0',
  `ensat_id` int(11) NOT NULL,
  `center_id` varchar(5) NOT NULL,
  `normal_tissue_type` varchar(30) DEFAULT NULL,
  `normal_tissue_specific` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`napaca_biomaterial_normal_tissue_id`,`napaca_biomaterial_id`,`ensat_id`,`center_id`),
  KEY `ensat_id` (`ensat_id`,`center_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `NAPACA_Imaging` (
  ...
  `right_adrenal_max_tumor` varchar(30) DEFAULT NULL,
  `left_adrenal_max_tumor` varchar(30) DEFAULT NULL,
...
CREATE TABLE `Pheo_BiochemicalAssessment` (
  ...
  `ensat_id` int(11) NOT NULL,
  `center_id` varchar(5) NOT NULL,
  `plasma_e` varchar(30) DEFAULT NULL,
  `plasma_n` varchar(30) DEFAULT NULL,
  `plasma_date` date DEFAULT NULL,
  `plasma_free_m` varchar(30) DEFAULT NULL,
  `plasma_free_n` varchar(30) DEFAULT NULL,
  `plasma_free_methox` varchar(30) DEFAULT NULL,
  `plasma_free_date` date DEFAULT NULL,
  `serum_chromo_a` varchar(30) DEFAULT NULL,
  `serum_chromo_a_date` date DEFAULT NULL,
  `urine_free_e` varchar(30) DEFAULT NULL,
  `urine_free_n` varchar(30) DEFAULT NULL,
  `urine_free_date` date DEFAULT NULL,
  `urine_m` varchar(30) DEFAULT NULL,
  `urine_n` varchar(30) DEFAULT NULL,
  `urine_date` date DEFAULT NULL,
  `plasma_dopamine_conc` varchar(30) DEFAULT NULL,
...
CREATE TABLE `Pheo_Biomaterial_Normal_Tissue` (
  ...
  `pheo_biomaterial_id` int(11) NOT NULL DEFAULT '0',
  `ensat_id` int(11) NOT NULL,
  `center_id` varchar(5) NOT NULL,
  `normal_tissue_type` varchar(30) DEFAULT NULL,
  `normal_tissue_specific` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`pheo_biomaterial_normal_tissue_id`,`pheo_biomaterial_id`,`ensat_id`,`center_id`),
  KEY `ensat_id` (`ensat_id`,`center_id`)
...
CREATE TABLE `Pheo_ClinicalAssessment` (
  ...
  `height` varchar(30) DEFAULT NULL,
  `weight` varchar(30) DEFAULT NULL,
  `systolic_blood_pressure` varchar(30) DEFAULT NULL,
  `diastolic_blood_pressure` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`clinical_assessment_id`,`ensat_id`,`center_id`),
  KEY `ensat_id` (`ensat_id`,`center_id`)
...
CREATE TABLE `Pheo_ImagingTests` (
  ...
  `ct_primary` varchar(30) DEFAULT NULL,
  `ct_metastases` varchar(30) DEFAULT NULL,
  `nmr` varchar(30) DEFAULT NULL,
  `nmr_date` date DEFAULT NULL,
  `nmr_primary` varchar(30) DEFAULT NULL,
  `nmr_metastases` varchar(30) DEFAULT NULL,
  `mibg` varchar(30) DEFAULT NULL,
  `mibg_date` date DEFAULT NULL,
  `mibg_primary` varchar(30) DEFAULT NULL,
  `mibg_metastases` varchar(30) DEFAULT NULL,
  `octreoscan` varchar(30) DEFAULT NULL,
  `octreoscan_date` date DEFAULT NULL,
  `octreoscan_primary` varchar(30) DEFAULT NULL,
  `octreoscan_metastases` varchar(30) DEFAULT NULL,
  `fdg_pet` varchar(30) DEFAULT NULL,
  `fdg_pet_date` date DEFAULT NULL,
  `fdg_pet_primary` varchar(30) DEFAULT NULL,
  `fdg_pet_metastases` varchar(30) DEFAULT NULL,
  `da_pet` varchar(30) DEFAULT NULL,
  `da_pet_date` date DEFAULT NULL,
  `da_pet_primary` varchar(30) DEFAULT NULL,
  `da_pet_metastases` varchar(30) DEFAULT NULL,
  ...
  `other_imaging_primary` varchar(30) DEFAULT NULL,
  `other_imaging_metastases` varchar(30) DEFAULT NULL,
...
CREATE TABLE `Pheo_PatientHistory` (
  ...
  `height_at_time_consent` varchar(30) DEFAULT NULL,
  `weight_at_time_consent` varchar(30) DEFAULT NULL,
  `systolic_bp_at_time_consent` varchar(30) DEFAULT NULL,
  `diastolic_bp_at_time_consent` varchar(30) DEFAULT NULL,
  ...
  `relatives_with_tumors` varchar(30) DEFAULT NULL,
  ...
  `further_detail` varchar(100) DEFAULT NULL,
...
CREATE TABLE `Pheo_Surgery` (
  ...
  `comment` varchar(100) DEFAULT NULL,
  `proliferative_index` varchar(30) DEFAULT NULL,
  `ki67_numbers` varchar(30) DEFAULT NULL,
  `mitotic_count_numbers` varchar(30) DEFAULT NULL,
  `cell_count_numbers` varchar(30) DEFAULT NULL,
...
-- Dump completed on 2012-10-16  5:14:32
