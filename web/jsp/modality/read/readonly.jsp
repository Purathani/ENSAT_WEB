...
<h2><%=dbn%> <%=pageTitle%> Record <%=modid%> (Read Only)</h2>

<p><div id="myDiv_update_subform"></div></p>

<table border="1px" cellpadding="5">
    <%
    String parameterHtml = updatesub.getParameterReadonlyHtml(parameters, lineColour);
    %>
    <%= parameterHtml %>
</table>

<p><a href="./jsp/modality/readonly.jsp?dbid=<%=dbid%>&dbn=<%=dbn%>&pid=<%=pid%>&centerid=<%=centerid%>&modality=<%=modality%>"/><strong>Back to <%=pageTitle%> summary</strong></a></p>
